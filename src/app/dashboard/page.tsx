              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="text-sm text-purple-100">
                    <span className="font-semibold text-white">15 verbs</span> • <span className="font-semibold text-white">4 tenses</span> • <span className="font-semibold text-white">360 cards</span>
                  </div>
